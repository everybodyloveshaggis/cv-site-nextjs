  ...
  return (
    <section className="mb-30 max-w-[50rem] text-center sm:mb-0">
      ...
      >
        ...
        <a
          className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition hover:cursor-pointer border border-black/10"
          href="/CV.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          className="bg-white p-4 flex items-center gap-2 rounded-full text-[#0077B5] focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition hover:cursor-pointer border border-black/10"
        ...
        <a
          className="bg-white p-4 flex items-center gap-2 rounded-full text-[1.20rem] focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition hover:cursor-pointer border border-black/10"
